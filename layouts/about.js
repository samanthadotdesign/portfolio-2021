...
export default function About() {
  ...
  return (
    <div
      className="homepage-div margin-bottom-36"
      ...
      <div className="container-fluid margin-top-60">
        <div className="row">
          <div className="col-md-8 px-0">
            <h1>
              Hi! I'm a multidisciplinary designer based in Singapore. Lately
              I've been designing with code to ship beautiful things.
            </h1>
          </div>
        </div>
        <div className="row margin-top-16">
          <div className="col-md-6 px-0">
            <h3>
              I'm currently a Lead Product Designer at Funding Societies, where
              I work on experiences to bring equitable access to business
              financing.
            </h3>
          </div>
