...
Designer Starter Pack is an interactive Figma skill map to keep track of resources and progress, that reflect industry expectations for beginner and intermediate learners. I curated a list of useful skills for working with Figma, with recommended resources. It's currently limited at this definitive list of skills.
