...
<div className="row d-flex justify-content-between">
  <div className="row d-flex">
    ...
    <div className="col-md-4 padding-right-24">
      ...
      <div className="padding-bottom-24"></div>
      <BlockQuote>
        You have so parents watching.
        <br />
        <br />
    ...
    <div className="col-md-4 padding-right-24">
      <p className="lesson-header">Stressful for patients</p>
      <MarkdownImage
        src="/images/work/vm/childhand.jpeg"
        width="600px"
        height="400px"
        layout="fill"
      />
      ...
      <figcaption>
        <a href="https://depositphotos.com/photo/doctor-checking-radial-pulse-young-asian-girl-who-visit-hospital-406592490.html">
          Photo source
        </a>
      </figcaption>
    </div>
    <div className="col-md-4 padding-left-24 padding-bottom-24">
      <p className="lesson-header">Stressful for clinicians</p>
      <MarkdownImage
        src="/images/work/vm/emergency.jpeg"
        width="600px"
        height="400px"
        layout="fill"
      />
      ...
      <figcaption>
        <a href="https://www.nib.com.au/the-checkup/how-much-does-it-cost-to-call-an-ambulance">
          Photo source
        </a>
      </figcaption>
    </div>
