...
<div className="col-md-4 ps-md-4">
  ...
  <p>
    <b>Improve vein visualization user experience.</b> NUHS already developed a
    proof of concept that uses the infrared camera on the HoloLens2 itself to
    detect the veins on a person’s hand. Our role was to make the vein mapping
    HL2 app user-friendly.
  </p>
</div>
  ...
  <div className="row d-flex">
    ...
    <div className="col-md-4 padding-right-24">
      ...
      <p>
        ...
        flow is different. For example, the veins or blood flow direction is not visible in children.</p>
    </div>
    <div className="col-md-4 px-md-4">
     <p className="lesson-header">Learning on the job</p>
      <p>
        Junior doctors have some training as a medical student, but the clinic setting is very different. It is difficult to get practice in because a senior doctor will step in in challenging cases, specially in an emergency.   
      </p>
    </div>
    <div className="col-md-4 ps-md-4">
      <p className="lesson-header">Under high pressure</p>
      <p>
        Clinicians experience performance anxiety. If the clinician isn't able to get the correct depth on the first attempt, they have to decide whether to reattempt or adjust the needle while it is already under the skin. 
      </p>
      <BlockQuote>
        With kids, the parents are there watching you. You really only have that one or two shots at it. 
        <br />
        <br />
...
<h2 id="3d-ultrasound">Main flow</h2>
  <div className="row d-flex">
    <div className="col-md-4 pe-md-4">
    <p>
      Immediately see veins. 
    </p>
</div>

<div className="col-md-8">
    <LoopingVideo src="/images/work/vm/vein-default.mp4" />
  </div>
</div>
</div>
