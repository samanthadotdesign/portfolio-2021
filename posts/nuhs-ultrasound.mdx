...
<div className="container-fluid margin-top-36">
  <div className="row d-flex">
    <div className="col-md-4 padding-right-24">
      <p className="lesson-header">Head-locked global menu</p>
      <p>
    ...
    <div className="col-md-4 padding-right-16 padding-bottom-24">
      ...
      <p>
        By default, the collapsed menu will appear 30–34cm in front of the user.
        Although 45cm was recommended for direct manipulation in Microsoft
        documentation, we found that for near-patient operations like
        ultrasound, the menu is more intuitively reachable with a shorter
        distance. The menu is offset to the left by default, so the center view
        is unobstructed.
      </p>
    </div>
    <div className="col-md-4 padding-left-16">
...
<div className="container-fluid margin-top-36">
  <div className="row d-flex">
    <div className="col-md-4 padding-right-24">
      ...
      <p>
        We changed the main navigation to be head-locked: it always appears in
        the same position in the user's field of view.
      </p>
    </div>
    <div className="col-md-4 padding-right-16 padding-bottom-24">
      <LoopingVideo src="/images/work/loan-origination-system/contextual-inquiry.mp4" />
