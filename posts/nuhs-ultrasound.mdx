      ...
      <p>
       At first, we developed the app menu that followed the{" "}
        ...
        <ol>
          ...
          <li><b>Left-handed clinicians</b> find it more difficult to use the menu.</li>
        </ol>
      </p>
    </div>
...
<div className="container-fluid margin-top-36">
  <div className="row d-flex">
    ...
    <div className="col-md-4 padding-right-24">
      ...
      <p>
        Since conducting ultrasound on a patient requires the clinician to be
        close to the patient, the holographic frame is narrower and clutters
        quickly.
      </p>
      <p>
